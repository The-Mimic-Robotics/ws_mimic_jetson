#!/usr/bin/env python3
"""
Bringup with Teleoperation Launch File
Full system + Xbox controller for manual driving

This launch file starts:
1. Robot driver (ESP32)
2. ZED camera localization
3. Nav2 stack (costmaps, planning)
4. Xbox controller for manual control
5. RViz visualization

Use cases:
- Manual exploration to generate maps
- Manual driving while Nav2 costmaps are active
- Testing before autonomous navigation
- Override autonomous control with joystick

Controls:
- Hold ENABLE button (RB/R1) to control with joystick
- Release to allow Nav2 autonomous control
- Left stick: forward/backward + strafe
- Right stick: rotation
- TURBO button (LB/L1): faster speeds
"""
...
def generate_launch_description():
    ...
    enable_teleop_arg = DeclareLaunchArgument(
        'enable_teleop',
        default_value='true',
        description='Enable Xbox controller teleoperation'
    )
    ...
    # 4. Xbox Controller Teleoperation
    # This allows manual control - hold enable button to override Nav2
    ...
    # 5. RViz for visualization and goal setting
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
